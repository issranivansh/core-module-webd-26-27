...
export default function Create() {
    ...
    return(<div  className=" h-screen flex flex-col p-5 ">
        <input placeholder="Title"onChange={updateTitle} className=" bg-[#79553D] text-6xl font-bold text-[#F4F0E6] w-full font-silkscreen rounded-md my-6  text-center py-4"></input>
        <br/>
